...
public class Ellipse implements Shape {
	...
	public Ellipse(int x1, int y1, int id, Color color) {
		this.x1 = x1; this.x2 = x1;
		this.y1 = y1; this.y2 = y1;
		this.color = color;
		this.id = id;
	...
	public Ellipse(int x1, int y1, int x2, int y2, int id, Color color) {
		setCorners(x1, y1, x2, y2);
		this.color = color;
		this.id = id;
	}
	...
	public String toString() {
		return " "+x1+" "+y1+" "+x2+" "+y2+" "+"ellipse "+color.getRGB() + " " + id;
	}
}
