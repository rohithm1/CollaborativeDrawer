...
public class Segment implements Shape {
	...
	public Segment(int x1, int y1, int id, Color color) {
		this.x1 = x1; this.x2 = x1;
		this.y1 = y1; this.y2 = y1;
		this.color = color;
		this.id = id;
	...
	public Segment(int x1, int y1, int x2, int y2, int id, Color color) {
		this.x1 = x1; this.y1 = y1;
		this.x2 = x2; this.y2 = y2;
		this.color = color;
		this.id = id;
	...
	public String toString() {
		return " " + x1+" "+y1+" "+x2+" "+y2+" "+"segment "+color.getRGB()+" "+id;
	}
}
